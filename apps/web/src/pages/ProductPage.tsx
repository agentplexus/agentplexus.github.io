...
const products: Product[] = [
  ...
  },
  {
    ...
    slug: 'omnichat',
    category: 'library',
    tagline: 'Multi-Provider Chat Interface',
    description:
      'Unified chat API for building conversational interfaces with multiple LLM backends.',
    color: 'cyan',
    githubUrl: 'https://github.com/plexusone/omnichat',
    docsUrl: 'https://plexusone.dev/omnichat/',
    features: [
  ...
  },
  {
    ...
    slug: 'agentcomms',
    category: 'library',
    tagline: 'Agent Communication Protocol',
    description:
      'Inter-agent communication library for building multi-agent systems with message passing.',
    color: 'cyan',
    githubUrl: 'https://github.com/plexusone/agentcomms',
    docsUrl: 'https://plexusone.dev/agentcomms/',
    features: [
    ...
    useCases: [
      ...
      'Build agent swarms with message passing',
    ],
  },
  {
    name: 'OmniStorage',
  ...
  },
  {
    ...
    slug: 'elevenlabs-go',
    category: 'library',
    tagline: 'ElevenLabs Audio SDK',
    description:
      'Comprehensive Go SDK for ElevenLabs AI audio platform. 19 service wrappers covering TTS, STT, voice design, and music generation.',
    color: 'pink',
    ...
    useCases: [
      'Add voice to AI applications',
      'Build audio content generation tools',
      'Create voice assistants',
      'Generate podcast or narration content',
  ...
  },
  {
    ...
    slug: 'opik-go',
    category: 'library',
    tagline: 'Comet Opik SDK',
    description:
      'Complete Go SDK for Comet ML Opik. LLM observability and evaluation platform integration.',
    color: 'violet',
    ...
    useCases: [
      ...
      'Debug LLM workflows with traces',
  ...
  },
  {
    ...
    slug: 'shap-go',
    category: 'library',
    tagline: 'ML Explainability SDK',
    description:
      'Go SDK for SHAP (SHapley Additive exPlanations) machine learning model interpretability.',
    color: 'cyan',
    githubUrl: 'https://github.com/plexusone/shap-go',
    docsUrl: 'https://plexusone.dev/shap-go/',
    features: [
